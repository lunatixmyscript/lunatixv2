...
link="https://raw.githubusercontent.com/lunatixmyscript/lunatixv2/main"
# [ Warna ]
red='\e[1;31m'
green='\e[0;32m'
cyan='\e[0;36m'
...
clear
#IZIN=$( curl https://raw.githubusercontent.com/lunatixmyscript/lunaip/main/ip | grep $MYIP )
IZIN=$(curl -s https://raw.githubusercontent.com/lunatixmyscript/lunaip/main/ip | grep "$MYIP" | awk '{ print $4 }')
if [ $MYIP = $IZIN ]; then
...
mkdir -p /etc/lunatix
sleep 1
mkdir -p /etc/lunatix/limit
sleep 1
mkdir -p /etc/lunatix/limit/xray
sleep 1
mkdir -p /etc/lunatix/limit/xray/ip
sleep 1
mkdir -p /etc/lunatix/limit/xray/quota
sleep 1
mkdir -p /etc/lunatix/limit/ssh
sleep 1
mkdir -p /etc/lunatix/limit/ssh/ip
sleep 1
mkdir -p /etc/v2ray
sleep 1
mkdir -p /detail
...
touch /etc/lunatix/.l2tp
touch /etc/lunatix/.sstp
touch /etc/lunatix/.pptp
...
<font color="#00FF00"><b> LUNATIC TUNNELING </b></font><br>
...
<font color="#6A5ACD"><b> Buy VPN Premium Contact https://wa.me/6285955333616</br></font><br>
<font color='#FF0059'>▬</font><font color='#F1006F'>▬</font><font color='#E30085'>▬</font><font color='#D6009B'>▬</font><font color='#C800B1'>▬</font><font color='#BB00C7'>ஜ</font><font color='#AD00DD'>۩</font><font color='#9F00F3'>۞</font><font color='#9F00F3'>۩</font><font color='#AD00DD'>ஜ</font><font color='#BB00C7'>▬</font><font color='#C800B1'>▬</font><font color='#D6009B'>▬</font><font color='#E30085'>▬</font><font color='#F1006F'>▬</font>
END
...
wget https://github.com/lunatixmyscript/lunatixv2/raw/main/plugin.sh ; chmod 777 plugin.sh ; ./plugin.sh ; rm -fr plugin.sh
...
[Unit]
Description=Limit All Service By lunatix
...
[Unit]
Description=BadVPN Gaming Support Port 7300 By lunatix
Documentation=https://t.me/lunatix
After=syslog.target network-online.target
...
[Unit]
Description=WebSocket All OS By lunatix
...
[Unit]
Description=UDP Request By @lunatix
...
echo -e "              (Version 1.3.5) - by: @lunatix"
...
echo ""
figlet -k lunatixv2 | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1' && figlet -k Hysteria | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1'
echo "───────────────────────────────────────────────────────────────────────•"
echo ""
echo ""
...
echo -e " 〄 \033[1;37m ⌯ ⇢ \033[1;33mhttps://t.me/LunaticTunnel\033[0m"
echo ""
echo "───────────────────────────────────────────────────────────────────────•"
user_key="YaaDede007"
